...
namespace ETV.src.Controllers
{
    ...
    public class ItemController : ControllerBase
    {
        ...
        public ItemController(ItemService itemService, TeamService teamService, ILogger<ItemController> logger)
        {
        ...
        public async Task<IActionResult> CreateItem([FromRoute] Guid teamId, [FromBody] CreateItemRequest request)
        {
            ...
            _logger.LogInformation($"Item {item.Id} created in team {teamId} by user {userId}.");
        ...
        public async Task<IActionResult> GetTeamItems([FromRoute] Guid teamId)
        {
            ...
            var items = await _itemService.GetTeamItemsAsync(teamId);
        ...
        public async Task<IActionResult> UpdateItem([FromRoute] Guid teamId, [FromRoute] Guid itemId, [FromBody] UpdateItemRequest request)
        {
            ...
            _logger.LogInformation($"Item {itemId} updated in team {teamId} by user {userId}.");
        ...
        public async Task<IActionResult> DeleteItem([FromRoute] Guid teamId, [FromRoute] Guid itemId)
        {
            ...
            _logger.LogInformation($"Item {itemId} deleted from team {teamId} by user {userId}.");

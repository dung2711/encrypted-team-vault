...
namespace ETV.src.Services
{
    public class TeamService
    {
        ...
        public TeamService(AppDb context)
        {
            _context = context;
        }
        ...
        /// Cập nhật tên team
        /// </summary>
        public async Task UpdateTeamInfoAsync(Guid teamId, string teamName)
        {
            var team = await _context.Teams
                .FirstOrDefaultAsync(t => t.TeamId == teamId);
        ...
        public async Task<int> GetCurrentKeyVersionAsync(Guid teamId)
        {
            ...
            var latestKeyVersion = await _context.TeamMembers
                .Where(tm => tm.TeamId == teamId)
        ...
        /// <summary>
        /// Lấy số lượng members trong team
        /// </summary>
        ...
        /// </summary>
        public async Task<Role?> GetMemberRoleAsync(Guid teamId, Guid userId)
        {
            var teamMember = await _context.TeamMembers
                .FirstOrDefaultAsync(tm => tm.TeamId == teamId && tm.UserId == userId);
